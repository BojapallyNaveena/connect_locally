          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            {token ? (
              ...
              <div className="flex items-center gap-3">
                <Link to="/login-worker" className="text-[13px] font-black text-slate-900 dark:text-white border-2 border-slate-100 dark:border-white/10 px-6 py-2.5 rounded-2xl hover:border-violet-600 transition-all uppercase tracking-widest">
                  Login
                </Link>
        ...
        <div className="px-4 pt-2 pb-6 space-y-2 bg-white dark:bg-black">
          ...
          <div className="pt-4 border-t border-slate-100 dark:border-white/10 mt-4 space-y-3">
            {token ? (
              ...
              <>
                <Link to="/login-worker" onClick={() => setIsMenuOpen(false)} className="block w-full text-center py-3 border-2 border-slate-100 dark:border-white/10 text-slate-900 dark:text-white rounded-xl font-bold uppercase tracking-widest">
                  Login
                </Link>
